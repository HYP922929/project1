...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='datasets/datasets.data', help='*.data path')#data/coco2014.data
    parser.add_argument('--weights', type=str, default='weights/best.pt', help='weights path')#'weights/yolov3-spp-ultralytics.pt'
