...
from backbone.resnet50_fpn_model import resnet50_backbone
...
def create_model(num_classes):
    ...
    weights_dict = torch.load("./backbone/fasterrcnn_resnet50_fpn_coco-258fb6c6.pth")
...
def main(parser_data):
    ...
    train_data_set = VOC(VOC_root, data_transform["train"], "train.txt")
